...
public class StudentDashboardController {
    ...
    public StudentDashboardController(StudentDashboardView view, Student student) throws IOException, FontFormatException {
        this.view = view;
    ...
    private void initDashboard() throws IOException, FontFormatException {
...
//            view.addResultRow(quizName, score + " / 10", status);
    ...
    private void loadQuizButtons() throws IOException, FontFormatException {
