...
public class QuizTakingView extends JFrame {
    ...
    public QuizTakingView() {
        ...
        questionLabel.setFont(FontUtil.montserrat(16f, Font.BOLD, new Font("Arial", Font.BOLD, 16)));
        ...
        for (int i = 0; i < 4; i++) {
            ...
            options[i].setFont(FontUtil.montserrat(14f, Font.PLAIN, options[i].getFont()));
        ...
        btnPrev.setFont(FontUtil.montserrat(12f, Font.BOLD, btnPrev.getFont()));
        btnNext.setFont(FontUtil.montserrat(12f, Font.BOLD, btnNext.getFont()));
        btnSubmit.setFont(FontUtil.montserrat(12f, Font.BOLD, btnSubmit.getFont()));
