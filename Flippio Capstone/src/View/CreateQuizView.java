...
public class CreateQuizView extends JFrame {
    ...
    private JButton removeQuestionBtn; // NEW BUTTON
    ...
    public CreateQuizView() {
        ...
        setSize(600, 750); // Slightly taller to fit new button
        ...
        // NEW: Remove Button
        removeQuestionBtn = new JButton("Remove Last Added");
        removeQuestionBtn.setBackground(new Color(255, 102, 102)); // Light Red
        removeQuestionBtn.setForeground(Color.WHITE);

        btnPanel.add(addQuestionBtn);
        btnPanel.add(removeQuestionBtn);
        ...
        // Apply Montserrat globally to this view
    ...
    // NEW: Helper to clear preview (used when deleting a question)
    public void clearPreview() {
        addedQuestionsPreview.setText("");
    }
    ...
    // NEW: Listener for remove button
